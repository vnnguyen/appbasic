    ...
    <body style="font-family:Candara; font-size:9pt;">
        <div style="width:800px; margin:auto;">
            ...
            <div>
                ...
                <p>Để xuất Devis TIẾNG ANH chọn <a href="<?=DIR?>imsprint-en/<?=SEG2?>/<?=SEG3?>">VÀO ĐÂY</a></p>
                <p>B2B tiếng PHÁP chọn vào đây <input type="checkbox" id="b2b-fr-options"/></p>
                ...
                <div class="option-img-banner-2">
                    <ul>
                        <li>
                            <p>Hạ long</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_1_halong.jpg'>
                            <input type="checkbox" value="banner2_1_halong"/>
                        </li>
                   
                        <li>
                            <p>Hội an</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_2_hoian.jpg'>
                            <input type="checkbox" value="banner2_2_hoian"/>
                        </li>
                    
                        <li>
                            <p>Marche ethnique</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_3_marche_ethnique.jpg'>
                            <input type="checkbox" value="banner2_3_marche_ethnique"/>
                        </li>
                   
                        <li>
                            <p>Delta mekong</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_4_delta_mekong.jpg'>
                            <input type="checkbox" value="banner2_4_delta_mekong"/>
                        </li>
                   
                        <li>
                            <p>Trek</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_5_trek.jpg'>
                            <input type="checkbox" value="banner2_5_trek"/>
                        </li>
                   
                        <li>
                            <p>Ethnie du nord</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_6_ethnie_du_nord.jpg'>
                            <input type="checkbox" value="banner2_6_ethnie_du_nord"/>
                        </li>
                   
                        <li>
                            <p>Rizieres terrace</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_7_rizieres_terrace.jpg'>
                            <input type="checkbox" value="banner2_7_rizieres_terrace"/>
                        </li>
                    
                        <li>
                            <p>Phú quốc</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_8_phu_quoc.jpg'>
                            <input type="checkbox" value="banner2_8_phu_quoc"/>
                        </li>
                    
                        <li>
                            <p>Tam cốc</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_9_tam_coc.jpg'>
                            <input type="checkbox" value="banner2_9_tam_coc"/>
                        </li>
                    
                        <li>
                            <p>Personne vietnamienne</p>
                            <img class="img-devis" style="width: 150px" src='<?= DIR ?>helpers/banner_2_devis/thumb/banner2_10_personne_vietnamienne.jpg'>
            ...
            <div id='sale-detail'>
                ...
                <p style='margin: 0; padding: 0; font-size: 9pt; color: #A00D80;font-family:Candara;'>Votre conseillère Amica Travel</p>
                <h2 id='devis-sale-name' style='margin: 0; padding: 0;font-family:Candara; font-size: 14pt;color:black;'>Mlle. <?=$theProduct['createdBy']['fname'] . ' ' . $theProduct['createdBy']['lname'] ?></h2>
                ...
                <table style="margin: 0;padding: 0;border: none;border-collapse: collapse;width: 268pt;">
                    <tr>
                        <td style="text-align: right;padding-top: 5pt;">
                            <p style="margin: 0; padding: 0; font-size: 9pt; color: #A00D80;font-family:Candara;">Votre conseillère Amica Travel</p>
                            <h2 style="margin: 0; padding: 0;font-family:Candara; font-size: 14pt;color:black;" id="devis-sale-name">Mlle. <?= $theProduct['createdBy']['fname'] . ' ' . $theProduct['createdBy']['lname'] ?></h2>
            ...
            <p style="font-family:Candara; font-size:9pt;">
                <strong>Devis No.<span id='devis-number' style='font-family:Candara; font-size: 14pt;font-weight:bold;'><?= preg_replace("/[^0-9]/","",$theProduct['title'])?></span></strong>

                <strong>Type du voyage:</strong> en individuel
                <br /><strong>Devis personnalisé pour:</strong><span id='devis-guest' style='font-family:Candara; font-size: 10pt;'><?= $theProduct['about'] ?></span> <?= $theProduct['about'] ?>
                <br /><strong>Durée & Date du voyage:</strong><span id='devis-date' style='font-family:Candara; font-size: 10pt;'> <?= count($dayIdList) ?> jours sur place, du <?= str_replace('/', '|', date('d/m/Y', strtotime($theProduct['day_from']))) ?> au <?= str_replace('/', '|', date('d/m/Y', strtotime('+ ' . (count($dayIdList) - 1) . ' day', strtotime($theProduct['day_from'])))) ?></span>
            </p>

            <h3 style="font-family:Candara; font-size:11pt;font-weight: bold;">Les points forts du programme</h3>
...
?>
            ...
            <h2 style="font-family: Candara;border-bottom:1px solid #09f; color:#09f; font-size: 30px;">Tableau synthétique du programme</h2>
            ...
            <table id='devis-table-programe' style='margin: 0; padding: 0; width: 166mm;border-collapse: collapse;'>
                <thead>
                    <tr style="margin: 2mm 0;">
                        <th style="text-align:left; width: 8.6%; padding: 2mm 1mm 2mm 0;"><h3 style="font-family:Candara; font-size:9pt; color:#a00d80; margin:0;">Jour</h3></th>
                ...
                <th style="text-align:left;width:  39.1%;"><h3 style="font-family:Candara; font-size:9pt; color:#a00d80; margin:0;padding-right: 1mm;">Itinéraire</h3></th>
                <th style="text-align:left;width: 22.6%;"><h3 style="font-family:Candara; font-size:9pt; color:#a00d80; margin:0;padding-right: 1mm;">Accompagnement</h3></th>
                <th style="text-align:left;width: 14.5%;"><h3 style="font-family:Candara; font-size:9pt; color:#a00d80; margin:0;">Repas inclus</h3></th>
                </tr>
                </thead>
                <?
                $cnt = 0;
...
//$ngay_fr = array('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche');
                            ...
                            ?>
                            <tr>
                                <td style="font-family:Candara; font-size:9pt;font-weight: bold;  padding: 5pt 0;"><strong>Jour <?= $cnt ?></strong></td>
            ...
            <p style="font-family:Candara; font-size:11pt;">BEGIN COPY</p>
            <div id='devis-detail' style="font-size: 9pt;">
                        ...
                        foreach ($dayIdList as $di) {
                            foreach ($theProduct['days'] as $ng) {
                                if ($ng['id'] == $di) {
                                    ...
                                    ?>
                            <h4 style="font-size:11pt; color:rgb(172,0,132);font-family:Candara;">Jour <?= $cnt ?> - <?= $ngay ?><span style="font-weight:normal"> | <?= $ng['name'] ?> (<?= $ng['meals'] ?>)</span></h4>
            ...
            <div id='devis-table-tarif'>
                ...
                <p style="font-family:Candara; font-size:9pt;">Conditions tarifaires établies le <?= date('d-m-Y', strtotime($theProduct['created_at'])) ?></p>
                ...
                <th style="padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid black;width: 17.8%; text-align: left;"><h3 style="font-family:Candara; color:#a00d80; font-size:9pt;">Ville</h3></th>
                <th style="padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid black; width: 20.5%;text-align: left;"><h3 style="font-family:Candara; color:#a00d80; font-size:9pt;">Hôtel</h3></th>
                <th style="padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid black; width: 22%;text-align: left;"><h3 style="font-family:Candara; color:#a00d80; font-size:9pt;">Catégorie chambre</h3></th >
                <th style="padding-left: 2mm;border-bottom: 1px solid black;text-align: left;width: 39.6%;font-size:9pt;">Référence</h3></th>
                </tr>';
                        }
...
<script>
    ...
    $('#download-word').click(function() {
        ...
        devis_prix = '<span style="font-family: Candara; font-size: 10pt; color:#8A006C;">' + prix_option + '</span> <b style="font-size: 14pt; font-family: Candara; color: #8A006C;">' + devis_prix + ' ' + $('#prix-money').text() + '</b> <span style="font-family: Candara; font-size: 14pt; color: #8A006C;">/</span> <span style="font-family: Candara; font-size: 12pt; color: #8A006C;">prs</span>';
