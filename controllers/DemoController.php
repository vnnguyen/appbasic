...
class DemoController extends MyController
{
    ...
    public function actionPush_queue()
    {
        ...
        $noti = Yii::$app->myNty::create(Yii::$app->myNty::KEY_NEW_ACCOUNT, [
            'datas' => [
                'user' => $user,
                'channels' => null
        ]]);
        // var_dump($noti);die;
        // Yii::$app->myNty::create(Yii::$app->myNty::KEY_NEW_ACCOUNT, [
        //     'datas' => $noti
        // ])->send();
        // var_dump(Yii::$app->getModule('notifications'));die;
