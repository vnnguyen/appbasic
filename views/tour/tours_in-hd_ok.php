...
$sql = 'SELECT u.name, u.phone, tu.role FROM at_users u, at_tour_user tu WHERE tu.user_id=u.id AND tu.tour_id=:tour_id AND tu.role IN ("cservice", "operator")';
    ...
    <table class="table table-condensed table-borderless mb-20">
        ...
        <tr>
            ...
            foreach ($tourguideList as $tourguide) {
                if ($tourguide['guide_user_id'] == $theForm->tourguide) {
