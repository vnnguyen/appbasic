...
$logo = (isset(Yii::$app->params['print_logo']))?Yii::$app->params['print_logo']:'';
...
<?php //var_dump($theTour);die();?>
<div class="col-md-8 col-md-offset-2">
    <div class="alert alert-info hidden-print">
        Click to go
        <?= Html::a('Back to tour', '/tours/r/'.$theTourOld['id'], ['class'=>'text-bold']) ?>
        or
        <?= Html::a('Back to select print options', Yii::$app->request->baseUrl.'/tour/in_lx/'.$theTour['id'], ['class'=>'text-bold']) ?>
    </div>
    <div class="clearfix">
