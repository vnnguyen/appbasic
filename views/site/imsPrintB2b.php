...
<html lang="fr">
    ...
    <body style="font-family:Bell MT;  font-size:11pt;">
        ...
        <div style="width:800px; margin:auto;">
            <h1 style="color:036; font-size:40px; margin:0 0 20px;">Xuất file devis tự động B2B Tiếng Pháp:</h1>
            ...
            <div class="option-devis">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <img class="img-devis" style="width: 145px" src='<?= DIR ?>assets/img/devis-ims/secretindochina/Devis_B2b_Fr_New.png'>
                            <input type="checkbox" value="Devis_B2b_Fr_New"/>
                        </li>
            ...
            <h2 style="border-bottom:1px solid rgb(229,55,145); color:rgb(229,55,145); font-size: 30px;">Front page | Trang bìa</h2>
               ...
               <br>
                <strong style='font-size: 12pt; font-family:Bell MT'>ESPRIT: </strong><br>
                <span id='devis-intro' style='font-family:Bell MT; font-size: 11pt;'><?= $theProduct['intro']?></span>

          

            <h3 style="font-family:Bell MT;  font-size:11pt;font-weight: bold;">POINTS FORTS</h3>
...
?>
            ...
            <h2 style="font-family: Candara;border-bottom:1px solid rgb(229,55,145); color:rgb(229,55,145); font-size: 30px;">PROGRAMME EN BREF </h2>
            <table border="1" id='devis-table-programe' style='margin: 0; padding: 0; width: 100%;border-collapse: collapse;border-color: rgb(191,191,191);'>
                ...
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid; border-color: rgb(191,191,191);width: 10%; padding: 2mm 1mm 2mm 0;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(229,55,145); margin:0;">Jour</h3></th>
                ...
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width:  39.1%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(229,55,145); margin:0;padding-right: 1mm;">Itinéraire</h3></th>
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width: 22.6%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(229,55,145); margin:0;padding-right: 1mm;">Accompagnement</h3></th>
                <th style="text-align:center;border-bottom: 1px solid;border-right: 1px solid;border-color: rgb(191,191,191);width: 17%;"><h3 style="font-family:Bell MT;  font-size:11pt; color:rgb(229,55,145); margin:0;">Repas inclus</h3></th>
                </tr>
                </thead>
                <?
                $cnt = 0;
...
//$ngay_fr = array('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche');
            ...
            <h2 style="border-bottom:1px solid rgb(229,55,145); color:rgb(229,55,145); font-size: 30px;">PROGRAMME EN DETAILS</h2>
            ...
            <h2 style="border-bottom:1px solid rgb(229,55,145); color:rgb(229,55,145); font-size: 30px;">HEBERGEMENTS</h2>
            <div id='devis-table-tarif'>
                ...
                <th style="text-align:center;padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid rgb(191,191,191); border-right: 1px solid rgb(191,191,191); width: 20.5%;"><h3 style="background: none;font-family:Bell MT; color:rgb(229,55,145); font-size:11pt;">Hôtel/Resort & Website</h3></th>
                <th style="text-align:center;padding-left: 2mm;padding-right: 1mm;border-bottom: 1px solid rgb(191,191,191); border-right: 1px solid rgb(191,191,191); width: 22%;"><h3 style="background: none;font-family:Bell MT; color:rgb(229,55,145); font-size:11pt;">Nuitée(s)</h3></th >
                <th style="text-align:center;padding-left: 2mm;border-bottom: 1px solid rgb(191,191,191);border-right: 1px solid rgb(191,191,191); width: 39.6%;font-size:11pt;"><h3 style="background: none;font-family:Bell MT; color:rgb(229,55,145); font-size:11pt;">Type de chambre</h3></th>
                </tr>';
                        }
...
<td style="text-align:center;border-bottom: 1px solid rgb(191,191,191);border-right: 1px solid rgb(191,191,191); font-family:Bell MT;  font-size:11pt; padding: 5pt 2mm;" class="a-href"><span style="background-color: none;">' . trim($line[2]) . '</span></td></tr>';
            ...
            <h2 style="border-bottom:1px solid rgb(229,55,145); color:rgb(229,55,145); font-size: 30px;">TARIFS</h2>
            <div id='devis-condition'>
                <p style="font-family:Bell MT; font-size:11pt;">
                    Valable jusqu’au 31 Décembre 2016. Tarifs en <b>dollar américain/personne</b> hors des frais bancaires.
                </p>
...
//         });
    ...
    jQuery(function($) {
          ...
          $('.test a').click(function() {
            $('#image-header').html('<img data-val="'+$(this).data('val')+'" width="800" src="'+$(this).data('img')+'"/>');
            disablePopup();
        });
