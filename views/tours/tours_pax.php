...
$this->title = Yii::t('tours_pax', 'Pax list').': '.$theTour['op_code'];
	...
	<div class="table-responsive">
		<table class="table table-condensed table-striped table-bordered">
			<thead>
				<tr>
					<th width="20"></th>
					<th colspan="2"><?= Yii::t('tours_pax', 'Names');?></th>
					<th><?= Yii::t('tours_pax', 'Gender');?></th>
					<th><?= Yii::t('tours_pax', 'Birthdate');?></th>
					<th><?= Yii::t('tours_pax', 'Nationality');?></th>
					<th><?= Yii::t('tours_pax', 'Passport');?></th>
					<th><?= Yii::t('tours_pax', 'Email');?></th>
					<th><?= Yii::t('tours_pax', 'Phone');?></th>
					<th><?= Yii::t('tours_pax', 'Note');?></th>
				</tr>
			</thead>
			<tbody>
				<? $cnt = 0;
