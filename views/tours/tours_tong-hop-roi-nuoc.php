...
$this->title = Yii::t('tours_tong-hop-roi-nuoc', 'Lịch xem rối nước tháng').' '.date('n/Y', strtotime($month));
...
<div class="col-md-12">
	<form method="get" action="" class="form-inline well well-sm hidden-print">
		<select class="form-control" style="width:auto" name="month">
			...
			<option value="<?= $li['ym'] ?>" <?= $li['ym'] == $month ? 'selected="selected"' : ''?>><?= Yii::t('tours_tong-hop-roi-nuoc', 'Tháng'); ?> <?= $li['ym'] ?></option>
			<? } ?>
		</select>
	...
	<table class="table table-condensed table-striped table-bordered">
		<thead>
			<tr>
				<th width="20">TT</th>
				<th width="80" class="text-center"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Ngày'); ?></th>
				<th width="12%"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Giờ xem'); ?></th>
				<th><?= Yii::t('tours_tong-hop-roi-nuoc', 'Tour code'); ?></th>
				<th width="10%"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Điều hành'); ?></th>
				<th width="30">+/-</th>
				<th width="100"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Loại vé'); ?></th>
				<th width="30"><?= Yii::t('tours_tong-hop-roi-nuoc', 'SL'); ?></th>
				<th width="120"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Thành $'); ?></th>
				<th><?= Yii::t('tours_tong-hop-roi-nuoc', 'Ghi chú / guide'); ?></th>
			</tr>
		</thead>
		<tbody>
			<?
			...
			<? } ?>
			<tr>
				<td colspan="8" class="text-right"><?= Yii::t('tours_tong-hop-roi-nuoc', 'Tổng tiền'); ?></td>
