...
<div class="col-md-12">
	<form class="form-inline well well-sm">
		...
		<button type="submit" class="btn btn-primary"><?= Yii::t('tours_calendar_v', 'Go');?></button>
		<?= Html::a(Yii::t('tours_calendar_v', 'Next week'), '@web/tours/calendar?date='.$nextWeek) ?>
		|
		<?= Html::a(Yii::t('tours_calendar_v', 'Back to this week'), '/tours/calendar') ?>
		<!-- // TODO 
		|
	...
	<div class="table-responsive">
		<table class="table table-bordered table-condensed">
			<thead>
				<tr>
					<th width="80"><?= Yii::t('tours_calendar_v', 'Day');?></th>
					<th width="200"><?= Yii::t('tours_calendar_v', 'Tour');?></th>
					<th><?= Yii::t('tours_calendar_v', 'Activities');?></th>
				</tr>
			</thead>
			<tbody>
<?
