...
$this->title = Yii::t('tours_calendar-month', 'Tour calendar (30 days)');
...
?>
    ...
    <form class="form-inline well well-sm">
        ...
        <button type="submit" class="btn btn-primary"><?= Yii::t('tours_calendar-month', 'Go');?></button>
        <?= Html::a(Yii::t('tours_calendar-month', 'Next month'), '@web/tours/calendar-month?date='.$nextMonth) ?>
        |
        <?= Html::a(Yii::t('tours_calendar-month', 'Back to today'), '/tours/calendar-month') ?>
    </form>
    <div class="table-responsive">
        <table id="tbl-calendar" class="table table-bordered table-condensed">
            <tbody>
                <tr>
                    <th width="30"></th>
                    <th width="200" class="text-center bg-warning"><?= Yii::t('tours_calendar-month', 'Tour \ Ngày');?></th>
                    <? for ($i = 0; $i < 30; $i ++) { ?>
