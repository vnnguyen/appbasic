...
$this->title = Yii::t('tours_tong-hop-nuoc-uong', 'Tổng hợp nước uống trên xe, tháng ').$getMonth;
...
<div class="col-md-12">
	<form method="get" action="" class="form-inline well well-sm hidden-print">
		<select class="form-control" style="width:auto" name="month">
			...
			<option value="<?= $li['ym'] ?>" <?= $li['ym'] == $getMonth ? 'selected="selected"' : ''?>><?= Yii::t('tours_tong-hop-nuoc-uong', 'Tháng') ?> <?= $li['ym'] ?></option>
			<? } ?>
		</select>
		<?= Html::textInput('name', $name, ['class'=>'form-control', 'placeholder' => Yii::t('tours_tong-hop-nuoc-uong', 'Tên chi phí') ]) ?>
	...
	<table class="table table-condensed table-striped table-bordered">
		<thead>
			<tr>
				<th width="20"><?= Yii::t('tours_tong-hop-nuoc-uong', 'TT') ?></th>
				<th width="80" class="text-center"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Ngày') ?></th>
				<th width="12%"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Chi phí') ?></th>
				<th><?= Yii::t('tours_tong-hop-nuoc-uong', 'Tour code') ?></th>
				<th width="10%"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Điều hành') ?></th>
				<th width="100"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Giá') ?></th>
				<th width="30"><?= Yii::t('tours_tong-hop-nuoc-uong', 'SL') ?></th>
				<th width="120"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Thành $') ?></th>
				<th><?= Yii::t('tours_tong-hop-nuoc-uong', 'Ghi chú / guide') ?></th>
			</tr>
		</thead>
		<tbody>
			<?
			...
			?>
			<tr>
				<td colspan="6" class="text-right"><?= Yii::t('tours_tong-hop-nuoc-uong', 'Tổng') ?></td>
