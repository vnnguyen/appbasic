...
.links {color: #f8970c; margin-right: 10px;}
</style>
<div class="col-md-12">
    <form class="form-inline panel-search" id="formx">
        ...
        <?= Html::dropdownList('stype', $stype, ['' => 'loại dịch vụ', 'a' => 'Khách sạn/ Nhà Dân', 't' =>'Tàu', 'f' =>'Chuyến bay', 'v' => 'Tham quan', 'p' =>'Gói'], ['class'=>'form-control' ]) ?>
    ...
    <? } else { ?>
    <div id="filter"><a href="/appbasic/web/cpt/ex1" class="btn btn-warning" title="filter">Filter</a></div>
