		    		...
		    		<tr data-ltt-id="<?= $ltt['id']?>">
		    			...
		    			<?
		    				...
		    				foreach ($c_m as $v) {
		    					...
		    					$txt_m .= $arr_m[1].': <b>'. $arr_m[0].'</b><br />';
		    				}
		    			?>
		    			<td class="ltt-status"><?= $txt_m?></td>
		    			<td class="ltt-update"><?
		    			$updated_dt = '';
		    			...
		    			?>
		    			<td class="ltt_actions"> <span class="checked_ldntt <?= $color?>"><i class="fa fa-check-square fa-2x" aria-hidden="true"></i></span> <span class="cancel_ldntt"><i class="fa fa-ban fa-2x" aria-hidden="true"></i></span> <!-- <span class="delete_ldntt"><i class="fa fa-trash" aria-hidden="true"></i></span> --> </td>
		    		</tr>
		    	<?php endforeach ?>
		    </tbody>
		</table>
